...
static const char* FontControlLabels[] = { B_TRANSLATE("Text"), B_TRANSLATE("Server messages"),
	B_TRANSLATE("URLs"), B_TRANSLATE("Names list"), B_TRANSLATE("Input text"),
	B_TRANSLATE("Window list"), B_TRANSLATE("Channel list"), B_TRANSLATE("Timestamp"), 0 };
	  ...
	  fActiveFont(0)
{
	...
	fFontElementField = new BMenuField("elements", B_TRANSLATE("Element:"), fElementMenu);
...
void
FontPrefsView::AttachedToWindow()
{
	BView::AttachedToWindow();
}

void
FontPrefsView::AllAttached()
{
	BView::AllAttached();
